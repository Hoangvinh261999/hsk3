...
import hsk3Words from '../data/hsk2Vocab.js';
...
const updatedWrongIds = !isAnsCorrect && !wrongIds.includes(currentWord.id)
  ? [...wrongIds, currentWord.id]
  : wrongIds;
      ...
      {currentWord ? (
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl sm:rounded-[2rem] shadow-2xl border-2 border-white/40 p-6 sm:p-8 lg:p-10 w-full max-w-sm sm:max-w-lg lg:max-w-2xl text-center transform transition-all duration-500 hover:scale-105 hover:shadow-3xl z-10 relative">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl font-black text-gray-800 bg-gradient-to-r from-purple-600 via-blue-600 to-green-600 bg-clip-text text-transparent leading-tight">
              {currentWord.meaning}
            </p>
          </div>
          ...
          <div className="mb-6 sm:mb-8">
            <input
              ...
              placeholder="输入汉字..."
              className="w-full px-6 sm:px-8 py-4 sm:py-5 text-4xl sm:text-4xl md:text-4xl text-center border-3 border-gray-300 rounded-2xl sm:rounded-3xl focus:border-blue-500 focus:ring-8 focus:ring-blue-200/50 transition-all duration-300 bg-gray-50/80 focus:bg-white outline-none font-bold shadow-lg hover:shadow-xl backdrop-blur-sm"
              autoFocus
            />
          </div>
